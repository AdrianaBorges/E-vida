...
namespace eVidaBeneficiarios.IR {
	public partial class ExtratoReembolso : PageBase {
		...
		private void Buscar() {
			...
			DataTable dtAcessos = ExtratoIrBeneficiarioBO.Instance.RelatorioReembolsoIr(UsuarioLogado.CdEmpresa, UsuarioLogado.CdFuncionario, ano);
