<%@ Page Title="SOLICITAÇÃO DE ATENDIMENTO PELO CONVÊNIO DE RECIPROCIDADE" Language="C#" MasterPageFile="~/Internal/Internal.Master" AutoEventWireup="true" CodeBehind="Reciprocidade.aspx.cs" Inherits="eVidaBeneficiarios.Forms.Reciprocidade" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placeHolder" runat="server">
    <div id="conteudo">
        ...
        <asp:GridView ID="gdvDependentes" runat="server" Width="100%" AutoGenerateColumns="false" 
            ...
            DataKeyNames="cd_beneficiario, BI3_TIPO, BA1_DATCAR">
        ...
        <div>
            <table width="50%">
                <tr>
                    <td align="center"><asp:Button ID="btnSalvar" runat="server" Text="Salvar" OnClick="btnSalvar_Click" OnClientClick="return confirmSave()" /></td>
                    <td align="center"><asp:Button ID="btnNova" runat="server" Text="Nova Solicitação" OnClientClick="goNova()" Visible="false" /></td>
                </tr>
            </table>
