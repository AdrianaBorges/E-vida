<%@ Page Title="SOLICITAÇÃO DE EXCLUSÃO DE BENEFICIÁRIOS" Language="C#" MasterPageFile="~/Internal/Internal.Master" AutoEventWireup="true" CodeBehind="Exclusao.aspx.cs" Inherits="eVidaBeneficiarios.Forms.Exclusao" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../Content/js/jquery/jquery.mask.min.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placeHolder" runat="server">
    ...
    <div id="idFormIssue">
	    ...
	    <table id="tbSelecao" runat="server" border="1" class="tabelaForm">
            <tr>
                <td colspan="3"><asp:DropDownList ID="dpdDependente" runat="server" DataValueField="Key" DataTextField="Value" OnSelectedIndexChanged="dpdDependente_SelectedIndexChanged" AutoPostBack="true" /></td>
        ...
        <asp:GridView ID="gdvDependentes" runat="server" Width="100%" AutoGenerateColumns="false" 
            ...
            DataKeyNames="Cdusuario, CodPlano">
            ...
            <table width="50%">
                <tr>
                    ...
                    <td align="center">
                        ...
                        <asp:HiddenField ID="hdnProtocolo" runat="server" />
                    ...
                    <td align="center">
                        <asp:HiddenField ID="hdnExibir" runat="server" />

                        <asp:Button ID="btnExibir" runat="server" 
                                    Text="Exibir" 
                                    OnClick="btnExibir_Click" />
                        

                    </td>
                    <td align="center"><asp:ImageButton ID="btnPdf" runat="server" Text="Imprimir" OnClientClick="return openPdf()" Visible="false" ImageUrl="~/img/PDF.png" Height="30px" /></td>
                    
                    <td align="center"><asp:Button ID="btnNova" runat="server" Text="Nova Solicitação" OnClientClick="return goNova()" Visible="false" /></td>
                </tr>
            </table>
