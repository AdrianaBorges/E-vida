<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="eVidaBeneficiarios.Externo.Header" %>
		<div id="header">
			<div class="logo">
				<asp:HyperLink ID="lnkInicial" runat="server">
					<asp:Image ID="imgLogo" runat="server" ToolTip="E-VIDA" AlternateText="Logo" ImageUrl="~/img/logo.png" Height="195" Width="211" />				
				</asp:HyperLink>
			</div>
			<div id="divMenu" class="menu">
				<div id="divHeaderInfo" runat="server" >
                    ...
                    Validade da Carteira: <asp:Literal ID="ltValidadeCarteira" runat="server" /><br />
                    <br />
                    <br />
				</div>
