<%@ Page Title="" Language="C#" MasterPageFile="~/Internal/InternalPopup.Master" AutoEventWireup="true" CodeBehind="PopBeneficiario.aspx.cs" Inherits="eVidaCredenciados.GenPops.PopBeneficiario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function setBeneficiario(id) {
