<%@ Page Title="" Language="C#" MasterPageFile="~/Internal/InternalPopup.Master" AutoEventWireup="true" CodeBehind="PopUpload.aspx.cs" Inherits="eVidaCredenciados.GenPops.PopUpload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placeHolder" runat="server">
    ...
    <table width="90%" cellspacing="10px" style="vertical-align:top;">
        <tr>
		    <td colspan="4"><h2 class="componentheading">Arquivo</h2></td>
	    </tr>
        <tr>
            <td>Arquivo:</td>
