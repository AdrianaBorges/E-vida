...
<div id="header" style="background:url(../img/bg-header-eleg.png) no-repeat center; height:140px;">
    <%--
	<div class="logo">
	...
	<div id="divMenu" class="menu">
		<div id="divHeaderInfo2" runat="server" style="height:0px;">
			<br />
		</div>
    ...
    <table id="tbResult" runat="server" cellpadding="10" cellspacing="10" style="width: 80%; margin-left:200px" visible="false" >
        ...
        <tr class="rodape_reciprocidade">
            <td colspan="2">
                <p style="font-size:large"><asp:Label ID="lblAtendimento" runat="server" Font-Bold="true" Text="Atendimentos de Urgência/Emergência devem ser realizados independente do período de carência" /></p>
            </td>
        </tr>
    </table>
</asp:Content>
