...
namespace eVidaIntranet.Forms {
	public partial class PopCancelExclusao : PopUpPageBase {
		protected override void PageLoad(object sender, EventArgs e) {
			...
			litProtocolo.Text = cdProtocolo.ToString(ExclusaoVO.FORMATO_PROTOCOLO);
		}
		...
		protected void btnSalvar_Click(object sender, EventArgs e) {
			...
			FormExclusaoBO.Instance.Cancelar(id, txtCancelamento.Text.ToUpper(), UsuarioLogado.Id);
