...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function reabrirSolicitacao(obj, id, row) {
            if (confirm("Deseja realmente reabrir a solicitação?")) {
                return true;
            }
            return false;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="placeHolder" runat="server">    
	<table width="1100px" cellspacing="10px">
		...
		<tr>
			...
			<td style="width:150px; text-align: right">Procedência: </td>
			<td align="left">
				<asp:DropDownList ID="dpdProcedencia" runat="server" Width="180px">
        ...
        <tr>
            <td style="width:100px; text-align: right">Necessita de Acompanhante:</td>
			<td align="left">
				<asp:DropDownList ID="dpdAcompanhante" runat="server" Width="220px">
		...
		<td colspan="4">
			...
			<asp:GridView ID="gdvRelatorio" runat="server" AutoGenerateColumns="false" DataKeyNames="CD_INDISPONIBILIDADE"
                ...
                <Columns>
			        ...
			        <asp:TemplateField HeaderText="Procedência">
				        <ItemTemplate>
                    ...
                    <asp:BoundField HeaderText="Necessita de Acompanhante" DataField="FL_ACOMPANHANTE" />
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
		                    ...
		                    <asp:LinkButton ID="btnReabrirSolicitacao" runat="server" CommandName="CmdReabrirSolicitacao" CommandArgument='<%# ((GridViewRow)Container).RowIndex %>' OnClientClick='<%# CreateJsFunctionGrid(Container, "reabrirSolicitacao") %>'>
			                    <asp:Image ID="imgReabrirSolicitacao"  runat="server" ImageUrl="~/img/abrir.png" Height="25px" AlternateText="Reabrir Solicitacao" ToolTip="Reabrir Solicitacao" />
		                    </asp:LinkButton>	
                        </ItemTemplate>
                    </asp:TemplateField>
				</Columns>
