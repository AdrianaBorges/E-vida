...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function openPdf(id) {
            window.open('../rpts/RelatorioEnvioReciprocidade.aspx?ID=' + id);
            return false;
        }
...
<table width="880px" cellspacing="10px">
	...
	<tr>
        ...
        <td><asp:DropDownList ID="dpdEmpresa" runat="server" Width="100%" DataTextField="Nome" DataValueField="Codigo" /></td>
	</tr>
    <tr>
		...
		<td>
			...
			<asp:GridView ID="gdvRelatorio" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
					...
					<asp:BoundField HeaderText="Empresa Conveniada" DataField="nm_empresa" SortExpression="nm_empresa" />
