...
<asp:Content ID="Content2" ContentPlaceHolderID="placeHolder" runat="server">
	...
	<table width="1200px" cellpadding="10px">
        ...
        <tr>
			<td>Natureza:</td>
			<td><asp:DropDownList ID="dpdNatureza" runat="server" Width="320px" DataValueField="Codesp" DataTextField="Descri" /></td>
            <td>Finalização:</td>
		...
		<tr style="height:300px">
			<td colspan="4">
                ...
                <Columns>
					...
					<asp:BoundField HeaderText="Natureza" DataField="BAQ_DESCRI" />
