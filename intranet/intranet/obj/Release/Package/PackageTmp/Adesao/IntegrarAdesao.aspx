	    ...
	    <tr>
		    <td>
                ...
                <table class="tbBorda" border="1">
                    ...
                    <tr>
                        <td><b>Categoria:</b></td><td>
                            <asp:DropDownList ID="dpdCategoria" runat="server" DataValueField="cd_categoria" DataTextField="ds_categoria" />
                        </td>
                    </tr>
                    <tr>
                        <td><b>Lotação:</b></td><td>
                            <asp:DropDownList ID="dpdLotacao" runat="server" DataValueField="Codorg" DataTextField="Descri" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><asp:DropDownList ID="dpdMotivoDesligamentoFamilia" runat="server" DataValueField="Key" DataTextField="Value" Enabled="false" /><br />
                            <asp:Literal ID="litMensagemPlanoExistenteFamilia" runat="server" Text="Este funcionário já possui família cadastrada no Protheus. Será necessário informar o motivo de um eventual bloqueio/desbloqueio de família." Visible="false" />
                    ...
                    <tr>
                        ...
                        <td><asp:DropDownList ID="dpdMotivoDesligamentoUsuario" runat="server" DataValueField="Key" DataTextField="Value" Enabled="false" /><br />
                            <asp:Literal ID="litMensagemPlanoExistenteUsuario" runat="server" Text="Este funcionário já possui beneficiário cadastrado no Protheus. Será necessário informar o motivo de um eventual bloqueio/desbloqueio de beneficiário." Visible="false" />
