		    ...
		    <td>
			    ...
			    <asp:GridView ID="gdvRelatorio" runat="server" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="INÍCIO VIGÊNCIA PLANO" DataField="BA1_DATCAR" DataFormatString="{0:dd/MM/yyyy}" />
                        <asp:BoundField HeaderText="TÉRMINO VIGÊNCIA" DataField="BA1_DATBLO" DataFormatString="{0:dd/MM/yyyy}" />
				    </Columns>
			    </asp:GridView>
		    </td>
	    </tr>
