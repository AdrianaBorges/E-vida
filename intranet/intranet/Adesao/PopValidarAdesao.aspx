...
<asp:Content ID="Content2" ContentPlaceHolderID="placeHolder" runat="server">
    <table width="500px">
        ...
        <tr>
            <td>
                <asp:DropDownList ID="dpdValidacao" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dpdValidacao_SelectedIndexChanged" >
        ...
        <tr>
            <td>
                <asp:Label ID="lblMotivo" runat="server" Text="Informe uma observação referente à validação:" />
            </td>
        </tr>
        <tr>
