   ...
   <table width="100%">
        <tr>
            <td>
                ...
                <table width="90%" cellspacing="1px" cellpadding="10px" style="padding-left:75px; margin-top:10px;" >
                    <tr>
                        <td><h1>Endereço da E-VIDA</h1></td>
                    </tr>
                    <tr>
                        <td align="center"> 
                            <asp:TextBox ID="txtEnderecoEVIDA" runat="server" Width="700px" />
                        </td>
                    </tr>
                </table>
                <table width="90%" cellspacing="1px" cellpadding="10px" style="padding-left:75px; margin-top:10px; margin-bottom:10px;" >
                    <tr>
                        <td align="center"> 
