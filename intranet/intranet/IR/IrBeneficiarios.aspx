<%@ Page Title="IR Beneficiários" Language="C#" MasterPageFile="~/Internal/Internal.Master" AutoEventWireup="true" CodeBehind="IrBeneficiarios.aspx.cs" Inherits="eVidaIntranet.IR.IrBeneficiarios" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	<script type="text/javascript">
		...
		function openPdfReembolso() {
		    ...
		    var emp = $('#<%= hidEmpresa.ClientID%>').val();
			var ano = $('#<%= dpdAnoRef.ClientID%>').val();
		    openReport('<%= ReportHandler.EnumRelatorio.REEMBOLSO_IR %>', "ANO=" + ano + "&MATRICULA=" + id + "&EMPRESA=" + emp);
			return false;
		}
			...
			<td>
				<asp:GridView ID="gdvReembolso" runat="server" AutoGenerateColumns="false"
					...
					<Columns>
						...
						<asp:BoundField HeaderText="Data Nasc Benef" DataField="dt_nascimento" DataFormatString="{0:dd/MM/yyyy}" />
						<asp:BoundField HeaderText="Data do atendimento" DataField="dt_atendimento_item" DataFormatString="{0:dd/MM/yyyy}" />
