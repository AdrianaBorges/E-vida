<%@ Page Title="" Language="C#" MasterPageFile="~/Internal/InternalPopup.Master" AutoEventWireup="true" CodeBehind="PopProfissional.aspx.cs" Inherits="eVidaIntranet.GenPops.PopProfissional" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
    	function setProfissional(id, nome) {
            ...
            <td colspan="5" align="center">
                ...
                <asp:GridView ID="gdv" runat="server" Width="100%" CssClass="tabela"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Codsig" ItemStyle-Width="150px" />
                    </Columns>
                </asp:GridView>
