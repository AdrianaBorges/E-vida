<%@ Page Title="Franquias Geradas" Language="C#" MasterPageFile="~/Internal/Internal.Master" AutoEventWireup="true" CodeBehind="RelatorioFranquiasGeradas.aspx.cs" Inherits="eVidaIntranet.Relatorios.RelatorioFranquiasGeradas" %>
				...
				<ContentTemplate>
					...
					<asp:GridView ID="gdvRelatorio" runat="server" AutoGenerateColumns="false"
						...
						<Columns>
							...
							<asp:BoundField HeaderText="VALOR LANÇAMENTO" DataField="vl_lancto" DataFormatString="{0:C}" />
							<asp:BoundField HeaderText="VALOR BENEFICIÁRIO" DataField="vl_beneficiario" DataFormatString="{0:C}" />
						</Columns>
					</asp:GridView>
				</ContentTemplate>
			</asp:UpdatePanel>
