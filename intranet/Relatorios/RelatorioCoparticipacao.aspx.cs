...
namespace eVidaIntranet.Relatorios {
	public partial class RelatorioCoparticipacao : RelatorioExcelPageBase {
		...
		protected void btnExportar_Click(object sender, EventArgs e) {
			...
			ExportExcel("RelatorioCoparticipacao", defs, sourceTable);
		}
		...
		protected void btnBuscar_Click(object sender, EventArgs e) {
			...
			try {
				DataTable dtAcessos = RelatorioBO.Instance.BuscarCoparticipacao(dtInicio, dtFim, lstSituacao, null, false);
