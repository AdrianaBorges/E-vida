<%@ Page Title="Relatório de Provisão" Language="C#" MasterPageFile="~/Internal/Internal.Master" AutoEventWireup="true" CodeBehind="RelatorioProvisao.aspx.cs" Inherits="eVidaIntranet.Relatorios.RelatorioProvisao" %>
	...
	<tr style="height:300px">
		<td colspan="4">
			...
			<asp:GridView ID="gdvRelatorio" runat="server" AutoGenerateColumns="false" 
				AllowSorting="false" CssClass="tabela" Width="2400px" OnSorting="gdvRelatorio_Sorting"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="TP DOC" DataField="tp_docto" SortExpression="tp_docto" />
