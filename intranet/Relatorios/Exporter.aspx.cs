...
namespace eVidaIntranet.Relatorios {
	...
	public partial class Exporter : Page {

		protected void Page_Load(object sender, EventArgs e) {
			byte[] rpt = Session["RELATORIO_BYTES"] as byte[];
			if (rpt == null)
				...
				//Response.AppendHeader("Content-Length", ""+sb.Length);
				...
				Stream stream = new MemoryStream(rpt);
