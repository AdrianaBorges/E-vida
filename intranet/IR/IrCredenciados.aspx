		...
		<tr style="height:300px">
			<td>
				...
				<asp:GridView ID="gdvResultado" runat="server" AutoGenerateColumns="false"
					...
					<Columns>
						<asp:BoundField HeaderText="CPF/CNPJ do PRESTADOR" DataField="BAU_CPFCGC" ItemStyle-HorizontalAlign="Right" />
						<asp:BoundField HeaderText="Prestador do Serviço" DataField="BAU_NOME" />
						<asp:BoundField HeaderText="Tipo pessoa" DataField="BAU_TIPPE" />
						<asp:HyperLinkField HeaderText="Comprovante Rendimentos e Retenções"  ItemStyle-HorizontalAlign="Center"
							DataNavigateUrlFields="BAU_CODIGO" DataNavigateUrlFormatString="IrCredenciados.aspx?id={0}&DW_FILE=1078"
