...
<table width="100%" style="padding:20px">
	<tr>
		<td>
			...
			<table id="tbDados" class="tbBorda" border="1">
                <tr>
                    <td colspan="2"><b>Protocolo<br />
                        <asp:Literal ID="litProtocolo" runat="server" /></b>
                    </td>
                    <td><b>Natureza:</b><br />
				...
				<tr>
					<td>
						...
						<b>CPF/CNPJ*</b>
						<asp:ImageButton ID="btnBuscarCredenciado" runat="server" ImageUrl="~/img/lupa.gif" OnClientClick="return openPopCredenciado()" OnClick="btnBuscarCredenciado_Click" Visible="false" /><br />
				...
				<tr>
                    <td><b>Doc. Fiscal</b><br />
                        <asp:TextBox ID="txtDocFiscal" runat="server" Width="200px" MaxLength="200" Enabled="false" />
                    </td>
                    <td><b>Data de Finalização:</b><br />
                        <asp:TextBox ID="txtDataFinalizacao" runat="server" CssClass="calendario" Width="100px" MaxLength="10" Enabled="false" /></td>
                ...
                <tr>
                    <td><b>Data de Emissão:</b><br />
                        <asp:TextBox ID="txtDataEmissao" runat="server" CssClass="calendario" Width="100px" MaxLength="10" Enabled="false" /></td>                    
					<td><b>Data de Entrada *</b><br />
						<asp:TextBox ID="txtDataEntrada" runat="server" CssClass="calendario" Width="100px" MaxLength="10" Enabled="false" /></td>                    
                    <td><b>Vencimento</b><br />
                        <asp:TextBox ID="txtVencimento" runat="server" CssClass="calendario" Width="80px" MaxLength="10" Enabled="false" />
                    </td>
				</tr>
                <tr>
                    <td><b>Valor Apresentado:</b><br />
                        <asp:TextBox ID="txtValorApresentado" runat="server" Width="200px" MaxLength="20" Enabled="false" />
                    </td>
                    <td><b>Valor Processado:</b><br />
                        <asp:TextBox ID="txtValorProcessado" runat="server" Width="200px" MaxLength="20" Enabled="false" />
                    </td>
                    <td><b>Glosa:</b><br />
                        <asp:TextBox ID="txtValorGlosa" runat="server" Width="200px" MaxLength="20" Enabled="false" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><b>Situação</b><br />
                        <asp:DropDownList ID="dpdSituacao" runat="server" Enabled="false" />
    ...
    <tr>
        <td>
            <h2>FINANCEIRO</h2>
            <asp:Label ID="lblFinanceiro" runat="server" ForeColor="Red" Text="Não foram encontrados os dados do financeiro no Protheus." Visible="false" />
            <table id="tbFinanceiro" class="tbBorda" border="1">
                <tr>
                    <td>
                        <b>Valor Original:</b><br />
                        <asp:Literal ID="litValor" runat="server" />
                    </td>
                    <td>
                        <b>Valor Pago:</b><br />
                        <asp:Literal ID="litValliq" runat="server" />
                    </td>
                    <td>
                        <b>Data Baixa:</b><br />
                        <asp:Literal ID="litBaixa" runat="server" />
                    </td>
                </tr>      
                <tr>
                    <td>
                        <b>ISS:</b><br />
                        <asp:Literal ID="litIss" runat="server" />
                    </td>
                    <td>
                        <b>IRRF:</b><br />
                        <asp:Literal ID="litIrrf" runat="server" />
                    </td>
                    <td>
                        <b>Desconto:</b><br />
                        <asp:Literal ID="litDescont" runat="server" />
                    </td>
                </tr>      
                <tr>
                    <td>
                        <b>COFINS:</b><br />
                        <asp:Literal ID="litCofins" runat="server" />
                    </td>
                    <td>
                        <b>PIS:</b><br />
                        <asp:Literal ID="litPis" runat="server" />
                    </td>
                    <td>
                        <b>CSLL:</b><br />
                        <asp:Literal ID="litCsll" runat="server" />
                    </td>
                </tr>                                           
            </table>
        </td>
