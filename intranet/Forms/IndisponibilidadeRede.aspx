...
<asp:Content ID="Content2" ContentPlaceHolderID="placeHolder" runat="server">
    <div id="conteudo">        
	    ...
	    <table id="tbInfoGeral" border="1" class="tabelaForm" style="width:950px">
		    ...
		    <tr>
			    <td style="text-align:center" colspan="4">
				    <b>Tempo em cada Setor</b><br />
				    <asp:GridView ID="gdvHorasSetor" runat="server" AutoGenerateColumns="false" CssClass="tabela" Width="600px" OnRowDataBound="gdvHorasSetor_RowDataBound" HorizontalAlign="Center">
					    <Columns>
						    <asp:BoundField HeaderText="Setor" DataField="Setor" />
						    <asp:BoundField HeaderText="Tempo" DataField="Horas" />
					    </Columns>
				    </asp:GridView>
			    </td>
		    </tr>	
        ...
        <asp:Panel ID="pnlSolicitacao" runat="server" DefaultButton="btnSalvarSolicitacao">
	        ...
	        <table id="tbBeneficiario" border="1" class="tabelaForm" style="width:950px">
	            ...
	            <tr>
		            <td colspan="3"><h2>DADOS DO ATENDIMENTO</h2>
		            </td>
	            </tr>
	            <tr>
		            <td align="left">
			            <b>Data do Atendimento:</b><br />
			            <asp:TextBox ID="txtDataAtendimento" runat="server" CssClass="calendario" Width="120px" MaxLength="10" />
		            </td>
		            <td colspan="2">
			            <b>Atendente:</b><br />
			            <asp:TextBox ID="txtAtendente" runat="server" Width="550px" ReadOnly="true" />
		            </td>
	            </tr> 	 
	            ...
	            <tr id="trObsEdit" runat="server" visible="false">
		            <td colspan="3" align="center">
			            ...
			            <asp:GridView ID="gdvObs" runat="server" AutoGenerateColumns="false" Width="900px" Visible="false" CssClass="tabela">
				            <Columns>
					            <asp:BoundField HeaderText="Data" DataField="DataRegistro" DataFormatString="{0:dd/MM/yyyy HH:mm}" ItemStyle-Width="100px"/>
					            <asp:BoundField HeaderText="Observação" DataField="Observacao" />
				            </Columns>
			            </asp:GridView><br />
			            <asp:TextBox ID="txtObsEdit" runat="server" Width="900px" TextMode="MultiLine"/><br />
	        ...
	        <table id="tbCredenciamento" border="1" class="tabelaForm" style="width:950px">
	            ...
	            <tr>
		            <td colspan="4" align="center">
			            ...
			            <asp:GridView ID="gdvPendencia" runat="server" AutoGenerateColumns="false" Width="900px" Visible="false" CssClass="tabela">
				            <Columns>
					            <asp:BoundField HeaderText="Data" DataField="DataRegistro" DataFormatString="{0:dd/MM/yyyy HH:mm}" ItemStyle-Width="100px"/>
					            <asp:BoundField HeaderText="Obs" DataField="Observacao" />
					            <asp:BoundField HeaderText="Pendência" DataField="Pendencia" ItemStyle-Width="150px" />
				            </Columns>
			            </asp:GridView><br />
			            <table>
				            <tr valign="top">
        ...
        <asp:Panel ID="pnlAutorizacao" runat="server" DefaultButton="btnSalvarAutorizacao" Visible="false">
	        ...
	        <table id="tbAutorizacao" border="1" class="tabelaForm" style="width:950px">
	            ...
	            <tr>
		            <td>
			            <asp:Label ID="lblAcompanhante" runat="server" Text="Necessita de Acompanhante" Font-Bold="true" />*<br />
			            <asp:DropDownList ID="dpdAcompanhante" runat="server">
        ...
        <asp:Panel ID="pnlDiretoria" runat="server" DefaultButton="btnSalvarDiretoria" Visible="false">
            <h2>6 - Aval do Superior Imediato</h2>
	        <table id="tbDiretoria" border="1" class="tabelaForm" style="width:950px">
                ...
                <tr>
                    <td style="text-align:center">
                        <asp:Button ID="btnSalvarDiretoria" runat="server" Text="Salvar Aval Superior Imediato" OnClick="btnSalvarDiretoria_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
	        ...
	        <table id="tbFaturamento" border="1" class="tabelaForm" style="width:950px">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtProtocoloFaturamento" runat="server" Width="200px" MaxLength="20" />
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        <b>Observação</b><br />
                        <asp:TextBox ID="txtObsFaturamento" runat="server" TextMode="MultiLine" Rows="3" Width="800px"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="text-align:center">
        ...
        <asp:Panel ID="pnlCadastro" runat="server" DefaultButton="btnSalvarCadastro" Visible="false">
            <h2>9 - Tratativas do Cadastro</h2>
	        <table id="tbCadastro" border="1" class="tabelaForm" style="width:950px">
                <tr>
                    <td colspan="4">
                        <b>Observação</b><br />
                        <asp:TextBox ID="txtObsCadastro" runat="server" TextMode="MultiLine" Rows="3" Width="800px"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="text-align:center">
                        <asp:Button ID="btnSalvarCadastro" runat="server" Text="Salvar dados Cadastro" OnClick="btnSalvarCadastro_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
